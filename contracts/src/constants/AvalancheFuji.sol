...
/// @dev SentryOracle / SentryQueue / the integration layer are chain-agnostic;
///      these constants exist for deploy scripts, tests, and example actors.
///      Unlike Somnia, Avalanche has no on-chain agent platform, so there is no
///      AGENT_PLATFORM address or agent-id here — Sentry on Avalanche guards
...
library AvalancheFuji {
    ...
    // denominated in wei-of-AVAX exactly as they were in wei-of-STT on Somnia.
}
