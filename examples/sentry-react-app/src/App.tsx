...
/** Minimal ABI for the SentryAgentBase POLICY_ID() view. The agent's bound
  ...
  return (
    <main className="page">
      <header>
        ...
        <p className="lede">
          This page gates a CounterAgent.bump write with the Sentry preflight
      ...
      <section className="card">
        ...
        {policy.kind === "error" && (
          <div className="warn">
            Could not read POLICY_ID from this address. Is it a SentryAgentBase
