...
Full Ward usage manual for Somnia Shannon — publish policies (CLI + dashboard), wire `checkIntent` into a Solidity agent, operate the queue, run watch mode, and deploy your own oracle if you must.
